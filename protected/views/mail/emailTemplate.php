            ...
            <tr>
                <td width="450">
                    ...
                    <div style="font-size:16px;line-height:26px;">
                        <?php echo Yii::t('emails', 'EMAIL_DEAR') . ' ' . $firstName; ?>&#44;<br />
                        <br />
                    ...
                    if ($emailButtonText == false) {
                        ...
                        <div align="center" style="padding-top:16px">
                            <a id="button" title="<?php echo Yii::t('emails', 'EMAIL_ALT_GO_TO_THE_WEB'); ?>" href="<?php echo $emailButtonLink; ?>" style="background-color:#66C;color:#FFF;cursor:pointer;font-family:arial;font-size:16px;font-weight:bold;line-height:32px;margin:0px 4px;padding:6px 9px;text-align:center;text-decoration:none;">
            ...
            <tr>
                <td width="450">
                    ...
                    if (isset($unsubscribeLink)) {
                        echo ' ' . '<a style="color:#666" href="' . $unsubscribeLink . '">' . Yii::t('emails', 'EMAIL_UNSUBSCRIBE') . '</a>' . ' ' . Yii::t('emails', 'EMAIL_FROM_JOB_ALERTS') . '.';
                    }
                    ?>
                </td>
            </tr>
