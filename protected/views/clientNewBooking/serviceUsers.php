...
<h2 class="rc-h2red"><?php echo Yii::t('texts', 'HEADER_SELECT_SERVICE_USERS'); ?></h2>
<div class="rc-container-40">
    <p class="rc-note">
        <?php echo Yii::t('texts', 'NOTE_USE_THE_BOX_ON_THE_LEFT_OF_THE_USER'); ?>
    </p>
    <div id="serviceUsersWidget">
...
<script type="text/javascript">
    $("#next").click(function() {
        var checkedBoxes = $('input:checkbox:checked.main_checkbox');

        if (checkedBoxes.length == 0) {

            $('#errorMessage').show();
            $('#errorMessage').html('<?php echo Yii::t('texts', 'ERROR_SELECT_AT_LEAST_ONE_USER'); ?>');
            window.scrollTo(0, 0);
            ...
            jQuery.yii.submitForm(this, '<?php echo Yii::app()->request->baseUrl ?>/clientNewBooking/serviceUser/navigation/next', {});
            return false;
        }
    }
    );
    ...
    $("#back").click(function() {
        ...
        jQuery.yii.submitForm(this, '<?php echo Yii::app()->request->baseUrl ?>/clientNewBooking/serviceUser/navigation/back.html', {});
        return false;
    }
    );
</script>