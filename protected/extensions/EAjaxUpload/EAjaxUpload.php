...
class EAjaxUpload extends CWidget {
    ...
    public function run() {
        ...
        echo '<div id="' . $this->id . '"><noscript><p>' . Yii::t('texts', 'ERROR_ACTIVATE_JS') . '</p></noscript></div>';
        ...
        //Added by Renaud, only way to change button text
        $template = '<div class="qq-uploader"><div class="qq-upload-drop-area"><span>' . Yii::t('texts', 'UPLOAD_DROP_FILES_HERE') . '</span></div><div class="qq-upload-button">' . $buttonText . '</div><span class="qq-upload-list"></span></div>';
