...
REPLACE INTO tbl_condition VALUES 
  (19, 'alzheimer', 2, 1),
  (17, 'cant_dressup', 1, 7),
  (16, 'cant_wakeup', 1, 6),
  (14, 'cant_walk', 1, 4),
...
REPLACE INTO tbl_document_type VALUES 
  (1, 'diploma'),
  (2, 'identification'),
  (3, 'photo'),
  (4, 'criminal'),
...
REPLACE INTO `tbl_document_requirement` (`id`, `id_document_type`, `requirement`) VALUES
(1, 3, 'nothing_head'),
(2, 3, 'one_person'),
(3, 3, 'no_nudity'),
...
(19, 1, 'type_and_year_do_not_match'),
(20, 4, 'not_full_page'),
(21, 2, 'type_and_year_do_not_match'),
(22, 4, 'type_and_year_do_not_match'),
(23, 5, 'type_and_year_do_not_match')
;

REPLACE INTO tbl_prices VALUES 
  (1, 'live_in_daily', 1, 99.50, 'GBP', '2012-12-01 00:00:00', '9999-12-31 00:00:00'),
  ...
  (11, 'hourly_price', 1, 10.95, 'GBP', '2013-04-01 18:15:36', '9999-12-31 00:00:00'),
  (12, 'hourly_price', 2, 9.00, 'GBP', '2013-04-01 18:16:30', '9999-12-31 00:00:00');
