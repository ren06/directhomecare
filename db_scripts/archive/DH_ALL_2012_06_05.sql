...
--
-- Host: localhost
-- Generation Time: Jun 05, 2012 at 10:53 PM
...
CREATE TABLE IF NOT EXISTS `tbl_address` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AVG_ROW_LENGTH=152 AUTO_INCREMENT=295 ;
...
CREATE TABLE IF NOT EXISTS `tbl_carer` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AVG_ROW_LENGTH=354 AUTO_INCREMENT=301 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AVG_ROW_LENGTH=84 AUTO_INCREMENT=295 ;
...
--
-- Table structure for table `tbl_carer_price`
--

CREATE TABLE IF NOT EXISTS `tbl_carer_price` (
  `type_price_type` int(11) NOT NULL DEFAULT '0',
  `start_time` time NOT NULL DEFAULT '00:00:00',
  `end_time` time NOT NULL DEFAULT '00:00:00',
  `price` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`start_time`,`type_price_type`,`end_time`,`price`),
  KEY `type_price_type` (`type_price_type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `tbl_carer_price`
--
...
CREATE TABLE IF NOT EXISTS `tbl_client_price` (
  ...
  `end_time` time NOT NULL DEFAULT '00:00:00',
  `price` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`start_time`,`end_time`,`type_price_type`,`price`),
  KEY `type_price_type` (`type_price_type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
