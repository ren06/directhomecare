...
-- Script date 22/05/2013 12:22:56
...
CREATE TABLE tbl_address (
  ...
  explanation VARCHAR(255) DEFAULT NULL COMMENT 'Used for service location to explain the client how to get there',
  PRIMARY KEY (id)
)
ENGINE = INNODB
AUTO_INCREMENT = 320
...
CREATE TABLE tbl_carer (
  ...
  modified DATETIME NOT NULL,
  created DATETIME NOT NULL,
  legally_work INT(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (id),
...
--
-- Definition for table tbl_client_location_address
--
...
--
-- Definition for table tbl_client_service_user
--
...
CREATE TABLE tbl_credit_card (
  ...
  last_three_digits VARCHAR(100) NOT NULL,
...
CREATE TABLE tbl_carer_document (
  ...
  id_content_crop INT(11) DEFAULT NULL,
  PRIMARY KEY (id),
...
--
-- Definition for table tbl_credit_card_expiry
--
...
--
-- Definition for table tbl_login_history_carer
--
DROP TABLE IF EXISTS tbl_login_history_carer;
CREATE TABLE tbl_login_history_carer (
  id INT(11) NOT NULL AUTO_INCREMENT,
  id_carer INT(11) NOT NULL,
  login_date_time DATETIME NOT NULL,
  PRIMARY KEY (id),
  CONSTRAINT FK_tbl_login_history_tbl_carer_id FOREIGN KEY (id_carer)
    REFERENCES tbl_carer(id) ON DELETE RESTRICT ON UPDATE RESTRICT
)
ENGINE = INNODB
AUTO_INCREMENT = 5
...
-- Definition for table tbl_login_history_carer
--
DROP TABLE IF EXISTS tbl_login_history_client;
CREATE TABLE tbl_login_history_client (
  id INT(11) NOT NULL AUTO_INCREMENT,
  id_client INT(11) NOT NULL,
  login_date_time DATETIME NOT NULL,
  PRIMARY KEY (id),
  CONSTRAINT FK_tbl_login_history_tbl_client_id FOREIGN KEY (id_client)
    REFERENCES tbl_client(id) ON DELETE RESTRICT ON UPDATE RESTRICT
)
ENGINE = INNODB
AUTO_INCREMENT = 5
...
--
-- Definition for table tbl_booking_gap
--
...
CREATE TABLE tbl_mission (
  ...
  discarded_by_client TINYINT(1) NOT NULL DEFAULT 0 COMMENT '0 = false, 1 = true',
...
--
-- Definition for table tbl_complaint
--
...
--
-- Definition for table tbl_mission_service_user
--
...
DROP TABLE IF EXISTS tbl_booking_hourly_day;
CREATE TABLE IF NOT EXISTS tbl_booking_hourly_day(
  id INT(11) NOT NULL AUTO_INCREMENT,
  id_booking INT(11) NOT NULL,
  day_week INT(1) NOT NULL,
  start_time TIME NOT NULL,
  ...
  PRIMARY KEY (id),
  CONSTRAINT FK_tbl_booking_houlry_tbl_booking_id FOREIGN KEY (id_booking)
  REFERENCES tbl_booking (id) ON DELETE RESTRICT ON UPDATE RESTRICT
)
ENGINE = INNODB
AUTO_INCREMENT = 386
...
DROP TABLE IF EXISTS tbl_carer_withdrawal;
CREATE TABLE tbl_carer_withdrawal(
  id INT(11) NOT NULL AUTO_INCREMENT,
  id_carer_transaction INT(11) NOT NULL,
  status INT(1) NOT NULL,
  ...
  modified DATETIME NOT NULL,
  PRIMARY KEY (id),
  CONSTRAINT FK_tbl_carer_withdrawal_tbl_carer_transaction_id FOREIGN KEY (id_carer_transaction)
  REFERENCES tbl_carer_transaction (id) ON DELETE RESTRICT ON UPDATE RESTRICT
)
ENGINE = INNODB
AUTO_INCREMENT = 2
